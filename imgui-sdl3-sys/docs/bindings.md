...
**Solution:**
Extract the SDL3 include directory from the `DEP_SDL3_CMAKE_DIR` environment variable and add it to the bindgen clang arguments:
...
#### Issue 10: SDL3 GPU Types Don't Implement Debug
...
#### Issue 11: Type Conflicts with ImDrawData and ImTextureData
